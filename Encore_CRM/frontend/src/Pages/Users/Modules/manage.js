    ...
    <React.Fragment>
      <Row className="GeneralHeading withBackArrow">
        ...
        <Col md={6} xs={6} className="text-end">
          <Button onClick={e => handleModulesDrawerToggle()} className="btn primary-btn mx-1">
            Add Modules
          </Button>
        </Col>
      </Row>
      ...
      <Drawer anchor="right" open={modulesDrawerState} onClose={handleModulesDrawerToggle} disableClose="false">
