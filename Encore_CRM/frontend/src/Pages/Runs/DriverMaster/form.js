...
import { driverType, status } from '../../Common/staticjson';
import PropTypes from 'prop-types';

const API_BASE_URL = process.env.REACT_APP_API_BASE_URL;


function FormDriver({ handleClose, rowData, appendData }) {
    ...
    async function submit(e) {
        ...
        try {
            ...
            const url = rowData._id ? `${API_BASE_URL}update-driver/${rowData._id}` : `${API_BASE_URL}add-driver`;
